...
/*	switch (type)
	{
		case Cmd::PET_TYPE_PET:
			SDWORD value =  (SDWORD)((petData.atk+appendMinDamage+skillValue.uppetdamage-skillValue.dpdam-skillValue.theurgy_dpdam)*(1.0f+((float)boostupPet+(float)skillValue.protectUpAtt)/100.0f));
			if (value <0) value = 0;
			return value;
			break;
...
/*	switch (type)
	{
		case Cmd::PET_TYPE_PET:
			SDWORD value = (SDWORD)((petData.maxatk+appendMaxDamage+skillValue.uppetdamage-skillValue.dpdam-skillValue.theurgy_dpdam)*(1.0f+((float)boostupPet+(float)skillValue.protectUpAtt)/100.0f));
			if (value <0) value =0;
			return value;
			break;
		case Cmd::PET_TYPE_SUMMON:
...
/*	switch (type)
	{
		case Cmd::PET_TYPE_PET:
			SDWORD value = (SDWORD)((petData.matk+appendMinDamage+skillValue.uppetdamage-skillValue.dmdam-skillValue.theurgy_dmdam)*(1.0f+((float)boostupPet+(float)skillValue.protectUpAtt)/100.0f));
			if (value<0) value =0;
			return value;
			break;
		case Cmd::PET_TYPE_SUMMON:
...
/*	switch (type)
	{
		case Cmd::PET_TYPE_PET:
			SDWORD value = (SDWORD)((petData.maxmatk+appendMinDamage+skillValue.uppetdamage-skillValue.dmdam-skillValue.theurgy_dmdam)*(1.0f+((float)boostupPet+(float)skillValue.protectUpAtt)/100.0f));
			if (value <0) value =0;
			return value;
			break;
		case Cmd::PET_TYPE_SUMMON:
...
void ScenePet::getAbilityByLevel(DWORD level)
{
	...
	/*
	   ...
	   {
	   for (unsigned int i=0;i<list.size()&&i<4;i++)
	   petData.skills[i] = list[i];
	   }
	   */
